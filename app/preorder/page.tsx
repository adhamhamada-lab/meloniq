...
function PreorderContent() {
  ...
  const discountedTotal = discountInfo && discountStatus === "valid"
    ? discountInfo.type === "percentage"
      ? Math.round(total * (1 - discountInfo.value / 100))
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] items-start gap-10 md:gap-20 max-w-[1400px] mx-auto">
          ...
          <div className="lg:sticky lg:top-32">
            ...
            <div className="mt-8 flex flex-col gap-3">
              {["Handcrafted with natural ingredients", "Pay on delivery — no upfront payment", "We'll contact you to confirm delivery"].map((text) => (
                <div key={text} className="flex items-start gap-3">
                  <span className="text-[#55614A] text-lg mt-1">✦</span>
                  <p className="text-[#66705D]">{text}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {done ? (
            <div className="bg-[#D7DCCB] rounded-[40px] p-10 text-center shadow-2xl mt-10">
              ...
              <p className="mt-4 text-[#66705D]">Thank you for choosing Meloniq. We'll be in touch shortly.</p>
            ...
            <form onSubmit={send} className="bg-[#D7DCCB] rounded-[30px] md:rounded-[60px] p-6 md:p-14 shadow-2xl w-full max-w-[700px] mx-auto flex flex-col gap-6 mt-10">
              ...
              <div className="flex flex-col gap-2">
                ...
                {discountStatus === "valid" && discountInfo && (
                  <p className="text-[#55614A] text-sm px-2">✓ Code applied — {discountInfo.value}{discountInfo.type === "percentage" ? "% off" : " EGP off"}</p>
                )}
